...
namespace RPG.Core
{
	...
	public class CameraAngleManager : MonoBehaviour
	{
		...
		private void Awake() => DictionaryInit();

		private void OnEnable() => AreaEventManager.OnEnterArea += ChangeCameraAngles;

		private void OnDisable() => AreaEventManager.OnEnterArea -= ChangeCameraAngles;
